...
def main():
    file1_path = 'tca name .txt'
    file2_path = 'file_without_py_extension.txt'
    file3_path = 'not_same_tca_name_2.txt'
...
with open('not_same_tca_name_2.txt', 'r') as not_same_tca_name_2:
    line = not_same_tca_name_2.readline()
    while line:
        print(line)  
        line = not_same_tca_name_2.readline()
        #print("\n")
